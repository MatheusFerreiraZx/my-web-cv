    ...
    <div className="max-w-3xl mx-auto">
      <section className="mb-12">
        ...
        <p className="text-text-secondary mb-4">
         Software Engineer with 5 years of experience and a strong experience in building large-scale, high-impact apps — especially in the financial industry.

      Having worked for leading banks and fintechs, I bring a solid understanding of scalability, performance, and user trust. 

      Skilled in Swift and modern software architectures, I’m now focused on elevating mobile experiences by combining code with design, motion, and branding.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-semibold mb-2">NTT DATA</h3>
          <h4 className="text-lg">Senior iOS Developer</h4>
          <p className="text-sm text-text-secondary">2025 - 2026</p>
          {/* <p className="mt-2">
